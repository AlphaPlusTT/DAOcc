...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("points_in_boxes_aux_cpu", &points_in_boxes_aux_cpu,
        "points_in_boxes_aux_cpu forward (CPU)");
  m.def("points_in_boxes_aux_batch", &points_in_boxes_aux_batch,
        "points_in_boxes_aux_batch forward (CUDA)");
}
